...
export const CouponCategoryManage = () => {
    ...
    const editButtonHandler = (id) => {
        dispatch(
            showDrawer({ id: id, title: `Edit Coupon Category`, show: true })
        );
    };
    ...
    // const columns = tableColumns.coupon_category; const searchFields =
    // columns.reduce(   (accumulator, currentValue) => [...accumulator,
    // currentValue.key],   [] );
    React.useEffect(() => {
        setLoading(true);
